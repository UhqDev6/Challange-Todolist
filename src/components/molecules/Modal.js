            ...
            <div  data-cy='moda-delete' className="w-2/6 md:h-auto mx-auto mt-56">
                <div className=" bg-white rounded-2xl shadow dark:bg-gray-700">
                    ...
                    <div className=" flex p-6 justify-between">
                        <Button onClick={() => closeModal(false)} className=" w-32 ml-20 text-gray-500 bg-gray-100 gap-9  hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-full  text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600 justify-center">Batal</Button>
                        <Button onClick={() => deleteActivity(dataActivity.id)}  className="text-white w-32 mr-20 bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-full text-sm inline-flex px-5 py-2.5 justify-center ">
                            Hapus
                        </Button>
                    </div>
                </div>
