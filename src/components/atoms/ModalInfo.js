...
const ModalInfo = ({setModalInformation}) => {
    return(
        <>
            <div className="fixed inset-0 bg-gray-600 bg-opacity-75" onClick={() => setModalInformation(false)}>
                    <div data-cy='modal-information' className="bg-white rounded-2xl shadow dark:bg-gray-700 w-2/6 md:h-auto mx-auto mt-80">
