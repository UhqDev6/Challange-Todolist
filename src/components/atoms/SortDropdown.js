                    ...
                    <div data-cy='sort-parent' className={'fixed z-20 shadow-sm w-[20%] ml-[62%] mt-[5%]'}>
                        {
                            sortOptionDropdown.map((sorting) => (
                                <div key={sorting.id}>
                                <div  data-cy='sort-selection' className="flex hover:bg-slate-100 border-b-[1px] py-4 px-3 text-gray-400 bg-white cursor-pointer" onClick={() => onHandlerDropdownSelected(sorting) }>
